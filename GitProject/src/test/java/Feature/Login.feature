...
Scenario Outline: 4.Verify login with invalid Credentials using data driven
...
Examples:
  ...
  | standard_user  | secret _sauce | Epic sadface: Username and password do not match any user in this service |
